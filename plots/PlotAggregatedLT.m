function PlotAggregatedLT(t,T1,T2,T3,P,limit)

global tm

name1 = strcat('Average LT Temperature');
name2 = strcat('LT Compressor Power');
...
figure('name','Avg LT Temperature vs LT Pack Duty');
